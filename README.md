...
| Assurance and AI insights | `mist_get_sle`, `mist_list_site_sle_info`, `mist_get_insight_metrics`, `mist_get_site_rrm_info`, `mist_troubleshoot` | Explore SLEs, Mist AI insight metrics, radio resource management state, and Marvis troubleshooting output. |
