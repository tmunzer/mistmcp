...
async def {operationId}(
    ...
    if config.transport_mode == "http":
        try:
            ...
            cloud = request.query_params.get("cloud", None).replace("https://", "").replace("http://", "")
            if request.headers.get("Authorization", None):
                apitoken = request.headers.get("Authorization", "").replace("Bearer ", "")
            else:
                apitoken = request.headers.get("X-Authorization", "").replace("Bearer ", "")
