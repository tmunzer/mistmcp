...
class TestServerConfig:
    ...
    def test_managed_configuration(self):
    ...
    def test_get_description_suffix(self):
    ...
    def test_should_load_tool_manager(self):
    ...
    def test_custom_mode_with_invalid_categories(self):
