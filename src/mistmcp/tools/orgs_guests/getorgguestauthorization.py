...
def add_tool() -> None:
    mcp.add_tool(
        fn=getOrgGuestAuthorization,
        name="getOrgGuestAuthorization",
        description="""Get Guest Authorization""",
        tags={"Orgs Guests"},
        annotations={
            "title": "getOrgGuestAuthorization",
            "readOnlyHint": True,
...
def remove_tool() -> None:
    mcp.remove_tool("getOrgGuestAuthorization")


async def getOrgGuestAuthorization(
