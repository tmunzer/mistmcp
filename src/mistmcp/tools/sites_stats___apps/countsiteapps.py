...
async def countSiteApps(
    ...
    device_mac: Annotated[Optional[str], Field(description="""MAC of the device""")]
    | None = None,
    app: Annotated[Optional[str], Field(description="""Application name""")]
    | None = None,
    wired: Annotated[
        Optional[str],
        Field(description="""If a device is wired or wireless. Default is False."""),
    ]
    | None = None,
