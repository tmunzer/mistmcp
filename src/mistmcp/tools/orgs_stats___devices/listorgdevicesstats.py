...
async def listOrgDevicesStats(
    ...
    evpntopo_id: Annotated[Optional[str], Field(description="""EVPN Topology ID""")] | None = None,
    evpn_unused: Annotated[Optional[str], Field(description="""If `evpn_unused`==`true`, find EVPN eligible switches which don’t belong to any EVPN Topology yet""")] | None = None,
    fields: Annotated[Optional[str], Field(description="""List of additional fields requests, comma separated, or `fields=*` for all of them""")] | None = None,
