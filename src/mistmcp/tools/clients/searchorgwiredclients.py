...
async def searchOrgWiredClients(
    ...
    auth_method: Annotated[Optional[str], Field(description="""Authentication method""")],
    source: Annotated[Optional[Source], Field(description="""source from where the client was learned (lldp, mac)""")] = Source.NONE,
    site_id: Annotated[Optional[str], Field(description="""Site ID""")],
    device_mac: Annotated[Optional[str], Field(description="""Device mac (Gateway/Switch) where the client has connected to""")],
    mac: Annotated[Optional[str], Field(description="""Partial / full MAC address""")],
    port_id: Annotated[Optional[str], Field(description="""Port id where the client has connected to""")],
    ...
    text: Annotated[Optional[str], Field(description="""Partial / full MAC address, hostname or username""")],
    ...
    dhcp_client_identifier: Annotated[Optional[str], Field(description="""DHCP Client Identifier""")],
    dhcp_vendor_class_identifier: Annotated[Optional[str], Field(description="""DHCP Vendor Class Identifier""")],
    dhcp_request_params: Annotated[Optional[str], Field(description="""DHCP Request Parameters""")],
    limit: Optional[int],
