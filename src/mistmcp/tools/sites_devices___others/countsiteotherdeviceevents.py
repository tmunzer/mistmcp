...
def remove_tool() -> None:
    mcp.remove_tool("countSiteOtherDeviceEvents")
...
async def countSiteOtherDeviceEvents(
    ...
    response = mistapi.api.v1.sites.otherdevices.countSiteOtherDeviceEvents(
        apisession,
        site_id=str(site_id),
