...
def remove_tool() -> None:
    mcp.remove_tool("listSiteOtherDevices")


async def listSiteOtherDevices(
    ...
    response = mistapi.api.v1.sites.otherdevices.listSiteOtherDevices(
        apisession,
        site_id=str(site_id),
        vendor=vendor,
        mac=mac,
