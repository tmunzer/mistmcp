...
def add_tool():
    mcp.add_tool(
        fn=getOrgSiteTemplate,
        name="getOrgSiteTemplate",
        description="""Get Org Site Template""",
        tags={"Orgs Site Templates"},
        annotations={
            "title": "getOrgSiteTemplate",
            "readOnlyHint": True,
...
def remove_tool():
    mcp.remove_tool("getOrgSiteTemplate")

async def getOrgSiteTemplate(
    org_id: Annotated[UUID, Field(description="""ID of the Mist Org""")],
    sitetemplate_id: Annotated[UUID, Field(description="""ID of the Mist Sitetemplate""")],
) -> dict:
    ...
    response = mistapi.api.v1.orgs.sitetemplates.getOrgSiteTemplate(
            apisession,
            org_id=str(org_id),
            sitetemplate_id=str(sitetemplate_id),
    )
