...
def remove_tool():
    mcp.remove_tool("searchOrgAlarms")

async def searchOrgAlarms(
    org_id: Annotated[UUID, Field(description="""ID of the Mist Org""")],
    site_id: Annotated[Optional[UUID], Field(description="""Site ID""")] | None = None,
    type: Annotated[Optional[str], Field(description="""Alarm type""")] | None = None,
    status: Annotated[Optional[str], Field(description="""Alarm status. Accepts multiple values separated by comma. enum: `open`, `resolved`""")] | None = None,
