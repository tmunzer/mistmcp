...
def add_tool():
    mcp.add_tool(
        fn=listSiteSiteTemplateDerived,
        name="listSiteSiteTemplateDerived",
        description="""Get derived Site Templates for Site""",
        tags={"Sites Site Templates"},
        annotations={
            "title": "listSiteSiteTemplateDerived",
            "readOnlyHint": True,
...
def remove_tool():
    mcp.remove_tool("listSiteSiteTemplateDerived")

async def listSiteSiteTemplateDerived(
    ...
    response = mistapi.api.v1.sites.sitetemplates.listSiteSiteTemplateDerived(
            apisession,
            site_id=str(site_id),
            resolve=resolve,
    )
