...
def remove_tool():
    mcp.remove_tool("countSiteAlarms")

async def countSiteAlarms(
    site_id: Annotated[UUID, Field(description="""ID of the Mist Site""")],
    distinct: Annotated[Distinct, Field(description="""Group by and count the alarms by some distinct field""")] = Distinct.TYPE,
    ...
    response = mistapi.api.v1.sites.alarms.countSiteAlarms(
            apisession,
            site_id=str(site_id),
