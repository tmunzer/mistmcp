...
async def searchOrgTunnelsStats(
    ...
    mxcluster_id: Annotated[Optional[str], Field(description="""If `type`==`wxtunnel`""")] | None = None,
    site_id: Annotated[Optional[str], Field(description="""ID of the Mist Site""")] | None = None,
    wxtunnel_id: Annotated[Optional[str], Field(description="""If `type`==`wxtunnel`""")] | None = None,
    ap: Annotated[Optional[str], Field(description="""If `type`==`wxtunnel`""")] | None = None,
    mac: Annotated[Optional[str], Field(description="""If `type`==`wan`""")] | None = None,
    node: Annotated[Optional[str], Field(description="""If `type`==`wan`""")] | None = None,
    peer_ip: Annotated[Optional[str], Field(description="""If `type`==`wan`""")] | None = None,
    peer_host: Annotated[Optional[str], Field(description="""If `type`==`wan`""")] | None = None,
    ip: Annotated[Optional[str], Field(description="""If `type`==`wan`""")] | None = None,
    tunnel_name: Annotated[Optional[str], Field(description="""If `type`==`wan`""")] | None = None,
    protocol: Annotated[Optional[str], Field(description="""If `type`==`wan`""")] | None = None,
    auth_algo: Annotated[Optional[str], Field(description="""If `type`==`wan`""")] | None = None,
    encrypt_algo: Annotated[Optional[str], Field(description="""If `type`==`wan`""")] | None = None,
    ike_version: Annotated[Optional[str], Field(description="""If `type`==`wan`""")] | None = None,
    up: Annotated[Optional[str], Field(description="""If `type`==`wan`""")] | None = None,
