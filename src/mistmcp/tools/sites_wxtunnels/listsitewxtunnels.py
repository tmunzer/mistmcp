...
def add_tool():
    mcp.add_tool(
        fn=listSiteWxTunnels,
        name="listSiteWxTunnels",
        description="""Get List of Site WxLan Tunnels""",
        tags={"Sites WxTunnels"},
        annotations={
            "title": "listSiteWxTunnels",
            "readOnlyHint": True,
...
def remove_tool():
    mcp.remove_tool("listSiteWxTunnels")

async def listSiteWxTunnels(
    ...
    response = mistapi.api.v1.sites.wxtunnels.listSiteWxTunnels(
            apisession,
            site_id=str(site_id),
            limit=limit,
            page=page,
