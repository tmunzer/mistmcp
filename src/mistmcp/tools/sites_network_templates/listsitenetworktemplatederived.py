...
def add_tool():
    mcp.add_tool(
        fn=listSiteNetworkTemplateDerived,
        name="listSiteNetworkTemplateDerived",
        description="""Get derived Network Templates for Site""",
        tags={"Sites Network Templates"},
        annotations={
            "title": "listSiteNetworkTemplateDerived",
            "readOnlyHint": True,
...
def remove_tool():
    mcp.remove_tool("listSiteNetworkTemplateDerived")

async def listSiteNetworkTemplateDerived(
    ...
    response = mistapi.api.v1.sites.networktemplates.listSiteNetworkTemplateDerived(
            apisession,
            site_id=str(site_id),
            resolve=resolve,
    )
