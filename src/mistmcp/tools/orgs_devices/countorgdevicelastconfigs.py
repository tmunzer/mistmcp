...
def remove_tool() -> None:
    mcp.remove_tool("countOrgDeviceLastConfigs")


async def countOrgDeviceLastConfigs(
    ...
    response = mistapi.api.v1.orgs.devices.countOrgDeviceLastConfigs(
        apisession,
        org_id=str(org_id),
        type=type.value,
