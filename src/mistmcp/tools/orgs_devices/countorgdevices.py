...
def remove_tool():
    mcp.remove_tool("countOrgDevices")
...
async def countOrgDevices(
    ...
    managed: Annotated[Optional[str], Field(description="""for switches and gateways, to filter on managed/unmanaged devices. enum: `true`, `false`""")] | None = None,
    mac: Annotated[Optional[str], Field(description="""AP mac""")] | None = None,
    version: Annotated[Optional[str], Field(description="""Version""")] | None = None,
    ip_address: Optional[str] | None = None,
    mxtunnel_status: Annotated[Mxtunnel_status, Field(description="""MxTunnel status, enum: `up`, `down`""")] = Mxtunnel_status.NONE,
    mxedge_id: Annotated[Optional[str], Field(description="""Mist Edge id, if AP is connecting to a Mist Edge""")] | None = None,
