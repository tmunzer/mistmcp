...
def add_tool():
    mcp.add_tool(
        fn=searchSiteNacClientEvents,
        name="searchSiteNacClientEvents",
        description="""Search NAC Client Events""",
        tags={"Sites Clients - NAC"},
        annotations={
            "title": "searchSiteNacClientEvents",
            "readOnlyHint": True,
...
def remove_tool():
    mcp.remove_tool("searchSiteNacClientEvents")
...
async def searchSiteNacClientEvents(
    ...
    idp_id: Annotated[Optional[UUID], Field(description="""SSO ID, if present and used""")] | None = None,
    idp_role: Annotated[Optional[str], Field(description="""IDP returned roles/groups for the user""")] | None = None,
    idp_username: Annotated[Optional[str], Field(description="""Username presented to the Identity Provider""")] | None = None,
    resp_attrs: Annotated[Optional[list], Field(description="""Radius attributes returned by NAC to NAS Devive""")] | None = None,
    ...
    random_mac: Annotated[Optional[bool], Field(description="""AP random macMAC""")] | None = None,
    mac: Annotated[Optional[str], Field(description="""MAC address""")] | None = None,
    timestamp: Annotated[Optional[float], Field(description="""Time, in epoch""")] | None = None,
    usermac_label: Annotated[Optional[str], Field(description="""Labels derived from usermac entry""")] | None = None,
    text: Annotated[Optional[str], Field(description="""Partial / full MAC address, username, device_mac or ap""")] | None = None,
    nas_ip: Annotated[Optional[str], Field(description="""IP address of NAS device""")] | None = None,
