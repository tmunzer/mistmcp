...
async def searchSiteNacClients(
    ...
    nacrule_id: Annotated[Optional[str], Field(description="""NAC Policy Rule ID, if matched""")] | None = None,
    ...
    vlan: Annotated[Optional[str], Field(description="""Vlan name or ID assigned to the client""")] | None = None,
    ...
    username: Annotated[Optional[str], Field(description="""Username presented by the client""")] | None = None,
    timestamp: Annotated[Optional[float], Field(description="""Start time, in epoch""")] | None = None,
    ap: Annotated[Optional[str], Field(description="""AP MAC connected to by client""")] | None = None,
    mac: Annotated[Optional[str], Field(description="""MAC address""")] | None = None,
    mdm_managed: Annotated[Optional[bool], Field(description="""Filters NAC clients that are managed by MDM providers""")] | None = None,
    mxedge_id: Annotated[Optional[str], Field(description="""ID of Mist Edge that the client is connected through""")] | None = None,
    nacrule_name: Annotated[Optional[str], Field(description="""NAC Policy Rule Name matched""")] | None = None,
    status: Annotated[Optional[str], Field(description="""Connection status of client i.e 'permitted', 'denied, 'session_ended'""")] | None = None,
    type: Annotated[Optional[str], Field(description="""Client type i.e. 'wireless', 'wired' etc.""")] | None = None,
    mdm_compliance: Annotated[Optional[str], Field(description="""MDM compliance of client i.e 'compliant', 'not compliant'""")] | None = None,
    mdm_provider: Annotated[Optional[str], Field(description="""MDM provider of client’s organisation eg 'intune', 'jamf'""")] | None = None,
    ...
    usermac_label: Annotated[Optional[list], Field(description="""Labels derived from usermac entry""")] | None = None,
    ingress_vlan: Annotated[Optional[str], Field(description="""Vendor specific Vlan ID in radius requests""")] | None = None,
