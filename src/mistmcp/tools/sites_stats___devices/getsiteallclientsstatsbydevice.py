...
def remove_tool() -> None:
    mcp.remove_tool("getSiteAllClientsStatsByDevice")


async def getSiteAllClientsStatsByDevice(
    site_id: Annotated[UUID, Field(description="""ID of the Mist Site""")],
    device_id: Annotated[UUID, Field(description="""ID of the Mist Device""")],
) -> dict:
    """Get wireless client stat by Device"""

    response = mistapi.api.v1.sites.stats.getSiteAllClientsStatsByDevice(
        apisession,
        site_id=str(site_id),
