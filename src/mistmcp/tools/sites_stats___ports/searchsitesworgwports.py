...
def remove_tool():
    mcp.remove_tool("searchSiteSwOrGwPorts")
...
async def searchSiteSwOrGwPorts(
    ...
    disabled: Annotated[Optional[bool], Field(description="""Indicates if interface is disabled""")] | None = None,
    mac: Annotated[Optional[str], Field(description="""Device identifier""")] | None = None,
    device_type: Annotated[Device_type, Field(description="""Device type""")] = Device_type.NONE,
    ...
    active: Annotated[Optional[bool], Field(description="""Indicates if interface is active/inactive""")] | None = None,
    jitter: Annotated[Optional[float], Field(description="""Last sampled jitter of the interface""")] | None = None,
    loss: Annotated[Optional[float], Field(description="""Last sampled loss of the interface""")] | None = None,
    latency: Annotated[Optional[float], Field(description="""Last sampled latency of the interface""")] | None = None,
    ...
    xcvr_part_number: Annotated[Optional[str], Field(description="""Optic Slot Partnumber, Check for null/empty""")] | None = None,
    auth_state: Annotated[Auth_state, Field(description="""If `up`==`true` && has Authenticator role""")] = Auth_state.NONE,
    lte_imsi: Annotated[Optional[str], Field(description="""LTE IMSI value, Check for null/empty""")] | None = None,
    lte_iccid: Annotated[Optional[str], Field(description="""LTE ICCID value, Check for null/empty""")] | None = None,
    lte_imei: Annotated[Optional[str], Field(description="""LTE IMEI value, Check for null/empty""")] | None = None,
