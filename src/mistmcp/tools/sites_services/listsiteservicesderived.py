...
def add_tool():
    mcp.add_tool(
        fn=listSiteServicesDerived,
        name="listSiteServicesDerived",
        description="""Retrieves the list of Services available for the Site""",
        tags={"Sites Services"},
        annotations={
            "title": "listSiteServicesDerived",
            "readOnlyHint": True,
...
def remove_tool():
    mcp.remove_tool("listSiteServicesDerived")

async def listSiteServicesDerived(
