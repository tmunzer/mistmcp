...
async def searchSiteServicePathEvents(
    ...
    type: Annotated[Optional[str], Field(description="""Event type, e.g. GW_SERVICE_PATH_DOWN""")] | None = None,
    text: Annotated[Optional[str], Field(description="""Description of the event including the reason it is triggered""")] | None = None,
    peer_port_id: Annotated[Optional[str], Field(description="""Port ID of the peer gateway""")] | None = None,
    peer_mac: Annotated[Optional[str], Field(description="""MAC address of the peer gateway""")] | None = None,
    vpn_name: Annotated[Optional[str], Field(description="""Peer name""")] | None = None,
    vpn_path: Annotated[Optional[str], Field(description="""Peer path name""")] | None = None,
    policy: Annotated[Optional[str], Field(description="""Service policy associated with that specific path""")] | None = None,
    port_id: Annotated[Optional[str], Field(description="""Network interface""")] | None = None,
    model: Annotated[Optional[str], Field(description="""Device model""")] | None = None,
    version: Annotated[Optional[str], Field(description="""Device firmware version""")] | None = None,
