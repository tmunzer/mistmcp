...
def remove_tool() -> None:
    mcp.remove_tool("searchSiteSkyatpEvents")


async def searchSiteSkyatpEvents(
    site_id: Annotated[UUID, Field(description="""ID of the Mist Site""")],
    type: Annotated[Optional[str], Field(description="""Event type, e.g. cc, fs, mw""")]
    | None = None,
    mac: Annotated[Optional[str], Field(description="""Client MAC""")] | None = None,
    device_mac: Annotated[Optional[str], Field(description="""Device MAC""")]
    | None = None,
    threat_level: Annotated[Optional[int], Field(description="""Threat level""")]
    | None = None,
