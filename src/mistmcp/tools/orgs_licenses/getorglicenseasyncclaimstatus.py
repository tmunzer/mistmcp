...
def add_tool():
    mcp.add_tool(
        fn=GetOrgLicenseAsyncClaimStatus,
...
def remove_tool():
    mcp.remove_tool("GetOrgLicenseAsyncClaimStatus")

async def GetOrgLicenseAsyncClaimStatus(
    org_id: Annotated[UUID, Field(description="""ID of the Mist Org""")],
    detail: Annotated[Optional[bool], Field(description="""Request license details""")] | None = None,
) -> dict:
