...
async def searchOrgSwOrGwPorts(
    ...
    full_duplex: Annotated[Optional[bool], Field(description="""Indicates full or half duplex""")],
    mac: Annotated[Optional[str], Field(description="""Device identifier""")],
    neighbor_mac: Annotated[Optional[str], Field(description="""Chassis identifier of the chassis type listed""")],
    neighbor_port_desc: Annotated[Optional[str], Field(description="""Description supplied by the system on the interface E.g. 'GigabitEthernet2/0/39'""")],
    neighbor_system_name: Annotated[Optional[str], Field(description="""Name supplied by the system on the interface E.g. neighbor system name E.g. 'Kumar-Acc-SW.mist.local'""")],
    poe_disabled: Annotated[Optional[bool], Field(description="""Is the POE configured not be disabled.""")],
    poe_priority: Annotated[Optional[Poe_priority], Field(description="""PoE priority.""")] = Poe_priority.NONE,
    poe_mode: Annotated[Optional[str], Field(description="""POE mode depending on class E.g. '802.3at'""")],
    poe_on: Annotated[Optional[bool], Field(description="""Is the device attached to POE""")],
    ...
    power_draw: Annotated[Optional[float], Field(description="""Amount of power being used by the interface at the time the command is executed. Unit in watts.""")],
    ...
    tx_mcast_pkts: Annotated[Optional[int], Field(description="""Multicast output packets""")],
    tx_bcast_pkts: Annotated[Optional[int], Field(description="""Broadcast output packets""")],
    rx_mcast_pkts: Annotated[Optional[int], Field(description="""Multicast input packets""")],
    rx_bcast_pkts: Annotated[Optional[int], Field(description="""Broadcast input packets""")],
    speed: Annotated[Optional[int], Field(description="""Port speed""")],
    mac_limit: Annotated[Optional[int], Field(description="""Limit on number of dynamically learned macs""")],
    mac_count: Annotated[Optional[int], Field(description="""Number of mac addresses in the forwarding table""")],
    up: Annotated[Optional[bool], Field(description="""Indicates if interface is up""")],
    stp_state: Annotated[Optional[Stp_state], Field(description="""If `up`==`true`""")] = Stp_state.NONE,
    stp_role: Annotated[Optional[Stp_role], Field(description="""If `up`==`true`""")] = Stp_role.NONE,
    auth_state: Annotated[Optional[Auth_state], Field(description="""If `up`==`true` && has Authenticator role""")] = Auth_state.NONE,
    optics_bias_current: Annotated[Optional[float], Field(description="""Bias current of the optics in mA""")],
    optics_tx_power: Annotated[Optional[float], Field(description="""Transmit power of the optics in dBm""")],
    optics_rx_power: Annotated[Optional[float], Field(description="""Receive power of the optics in dBm""")],
    optics_module_temperature: Annotated[Optional[float], Field(description="""Temperature of the optics module in Celsius""")],
    optics_module_voltage: Annotated[Optional[float], Field(description="""Voltage of the optics module in mV""")],
    type: Annotated[Optional[Type], Field(description="""Type of device. enum: `switch`, `gateway`, `all`""")] = Type.ALL,
    limit: Optional[int],
