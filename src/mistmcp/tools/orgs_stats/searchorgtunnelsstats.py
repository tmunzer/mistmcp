...
async def searchOrgTunnelsStats(
    ...
    mxcluster_id: Annotated[Optional[str | None], Field(description="""If `type`==`wxtunnel`""")] = None,
    site_id: Annotated[Optional[str | None], Field(description="""ID of the Mist Site""")] = None,
    wxtunnel_id: Annotated[Optional[str | None], Field(description="""If `type`==`wxtunnel`""")] = None,
    ap: Annotated[Optional[str | None], Field(description="""If `type`==`wxtunnel`""")] = None,
    mac: Annotated[Optional[str | None], Field(description="""If `type`==`wan`""")] = None,
    node: Annotated[Optional[str | None], Field(description="""If `type`==`wan`""")] = None,
    peer_ip: Annotated[Optional[str | None], Field(description="""If `type`==`wan`""")] = None,
    peer_host: Annotated[Optional[str | None], Field(description="""If `type`==`wan`""")] = None,
    ip: Annotated[Optional[str | None], Field(description="""If `type`==`wan`""")] = None,
    tunnel_name: Annotated[Optional[str | None], Field(description="""If `type`==`wan`""")] = None,
    protocol: Annotated[Optional[str | None], Field(description="""If `type`==`wan`""")] = None,
    auth_algo: Annotated[Optional[str | None], Field(description="""If `type`==`wan`""")] = None,
    encrypt_algo: Annotated[Optional[str | None], Field(description="""If `type`==`wan`""")] = None,
    ike_version: Annotated[Optional[str | None], Field(description="""If `type`==`wan`""")] = None,
    up: Annotated[Optional[str | None], Field(description="""If `type`==`wan`""")] = None,
