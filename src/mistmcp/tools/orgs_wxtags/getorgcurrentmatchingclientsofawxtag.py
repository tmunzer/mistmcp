...
def remove_tool():
    mcp.remove_tool("getOrgCurrentMatchingClientsOfAWxTag")
...
async def getOrgCurrentMatchingClientsOfAWxTag(
    ...
    response = mistapi.api.v1.orgs.wxtags.getOrgCurrentMatchingClientsOfAWxTag(
            apisession,
            org_id=str(org_id),
