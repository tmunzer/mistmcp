...
async def searchSiteSyntheticTest(
    ...
    port_id: Annotated[Optional[str | None], Field(description="""Port_id used to run the test (for SSR only)""")] = None,
    vlan_id: Annotated[Optional[str | None], Field(description="""VLAN ID""")] = None,
    by: Annotated[Optional[str | None], Field(description="""Entity who triggers the test""")] = None,
    reason: Annotated[Optional[str | None], Field(description="""Test failure reason""")] = None,
    type: Annotated[Optional[Type | None], Field(description="""Synthetic test type""")] = Type.NONE,
    protocol: Annotated[Optional[Protocol | None], Field(description="""Connectivity protocol""")] = Protocol.NONE,
    tenant: Annotated[Optional[str | None], Field(description="""Tenant network in which lan_connectivity test was run""")] = None,
