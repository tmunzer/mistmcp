...
async def searchSiteSyntheticTest(
    ...
    device_id: Annotated[
        Optional[UUID],
        Field(
            description="""ID of the Device that ran the test to filter by. Providing this parameter will return only the specified object and may provide additional information."""
        ),
    ] = None,
) -> dict:
