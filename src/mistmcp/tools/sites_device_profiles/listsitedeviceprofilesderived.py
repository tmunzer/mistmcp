...
def add_tool():
    mcp.add_tool(
        fn=listSiteDeviceProfilesDerived,
        name="listSiteDeviceProfilesDerived",
        description="""Retrieves the list of Device Profiles available for the Site""",
        tags={"Sites Device Profiles"},
        annotations={
            "title": "listSiteDeviceProfilesDerived",
            "readOnlyHint": True,
...
def remove_tool():
    mcp.remove_tool("listSiteDeviceProfilesDerived")

async def listSiteDeviceProfilesDerived(
    ...
    response = mistapi.api.v1.sites.deviceprofiles.listSiteDeviceProfilesDerived(
            apisession,
            site_id=str(site_id),
            resolve=resolve,
    )
