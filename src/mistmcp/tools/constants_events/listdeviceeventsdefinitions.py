...
def remove_tool():
    mcp.remove_tool("listDeviceEventsDefinitions")

async def listDeviceEventsDefinitions() -> dict:
    """Get list of available Device Events"""

    response = mistapi.api.v1.const.device_events.listDeviceEventsDefinitions(
            apisession,
    )
