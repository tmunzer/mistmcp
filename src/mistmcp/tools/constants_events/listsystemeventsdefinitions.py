...
def remove_tool():
    mcp.remove_tool("listSystemEventsDefinitions")

async def listSystemEventsDefinitions() -> dict:
    """Get List of List of available System Events"""

    response = mistapi.api.v1.const.system_events.listSystemEventsDefinitions(
            apisession,
    )
