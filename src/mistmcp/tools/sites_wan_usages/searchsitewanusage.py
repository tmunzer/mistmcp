...
async def searchSiteWanUsage(
    ...
    peer_mac: Annotated[Optional[str], Field(description="""Peer MAC address""")] | None = None,
    port_id: Annotated[Optional[str], Field(description="""Port ID for the device""")] | None = None,
    peer_port_id: Annotated[Optional[str], Field(description="""Peer Port ID for the device""")] | None = None,
    policy: Annotated[Optional[str], Field(description="""Policy for the wan path""")] | None = None,
    tenant: Annotated[Optional[str], Field(description="""Tenant network in which the packet is sent""")] | None = None,
    path_type: Annotated[Optional[str], Field(description="""path_type of the port""")] | None = None,
