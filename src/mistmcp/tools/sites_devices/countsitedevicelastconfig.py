...
def add_tool():
    mcp.add_tool(
        ...
        tags={"Sites Devices"},
        annotations={
            "title": "countSiteDeviceLastConfig",
            "readOnlyHint": True,
...
def remove_tool():
    mcp.remove_tool("countSiteDeviceLastConfig")

async def countSiteDeviceLastConfig(
    ...
    response = mistapi.api.v1.sites.devices.countSiteDeviceLastConfig(
            apisession,
            site_id=str(site_id),
