...
def remove_tool():
    mcp.remove_tool("countSiteDeviceEvents")

async def countSiteDeviceEvents(
    ...
    response = mistapi.api.v1.sites.devices.countSiteDeviceEvents(
            apisession,
            site_id=str(site_id),
