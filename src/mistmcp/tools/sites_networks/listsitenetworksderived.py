...
def add_tool():
    mcp.add_tool(
        fn=listSiteNetworksDerived,
        name="listSiteNetworksDerived",
        description="""Retrieves the list of Networks available for the Site""",
        tags={"Sites Networks"},
        annotations={
            "title": "listSiteNetworksDerived",
            "readOnlyHint": True,
...
def remove_tool():
    mcp.remove_tool("listSiteNetworksDerived")

async def listSiteNetworksDerived(
