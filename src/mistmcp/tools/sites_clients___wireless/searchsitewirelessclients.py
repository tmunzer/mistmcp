...
def add_tool():
    mcp.add_tool(
        fn=searchSiteWirelessClients,
        name="searchSiteWirelessClients",
        description="""Search Wireless Clients**NOTE**: fuzzy logic can be used with ‘*’, supported filters: mac, hostname, device, os, model. E.g. /clients/search?device=Mac*&hostname=jerry""",
        tags={"Sites Clients - Wireless"},
        annotations={
            "title": "searchSiteWirelessClients",
            "readOnlyHint": True,
...
def remove_tool():
    mcp.remove_tool("searchSiteWirelessClients")

async def searchSiteWirelessClients(
