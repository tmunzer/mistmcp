...
def add_tool():
    mcp.add_tool(
        fn=searchSiteWirelessClientSessions,
...
def remove_tool():
    mcp.remove_tool("searchSiteWirelessClientSessions")
...
async def searchSiteWirelessClientSessions(
    ...
    client_username: Annotated[Optional[str], Field(description="""Username""")] | None = None,
    ...
    psk_name: Annotated[Optional[str], Field(description="""PSK Name""")] | None = None,
