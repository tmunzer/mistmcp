...
def remove_tool():
    mcp.remove_tool("listOrgMxEdges")

async def listOrgMxEdges(
    org_id: Annotated[UUID, Field(description="""ID of the Mist Org""")],
    for_sites: Annotated[For_sites, Field(description="""Filter for site level mist edges""")] = For_sites.ANY,
