...
def remove_tool():
    mcp.remove_tool("countSiteSystemEvents")

async def countSiteSystemEvents(
    ...
    response = mistapi.api.v1.sites.events.countSiteSystemEvents(
            apisession,
            site_id=str(site_id),
