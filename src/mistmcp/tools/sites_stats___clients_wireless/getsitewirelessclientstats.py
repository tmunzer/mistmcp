...
def add_tool():
    mcp.add_tool(
        fn=getSiteWirelessClientStats,
        name="getSiteWirelessClientStats",
        description="""Get Site Client Stats Details""",
        tags={"Sites Stats - Clients Wireless"},
        annotations={
            "title": "getSiteWirelessClientStats",
            "readOnlyHint": True,
...
def remove_tool():
    mcp.remove_tool("getSiteWirelessClientStats")

async def getSiteWirelessClientStats(
