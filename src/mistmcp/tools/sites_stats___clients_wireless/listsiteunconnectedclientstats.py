...
def add_tool() -> None:
    mcp.add_tool(
        fn=listSiteUnconnectedClientStats,
        name="listSiteUnconnectedClientStats",
        description="""Get List of Site Unconnected Client Location""",
        tags={"Sites Stats - Clients Wireless"},
        annotations={
            "title": "listSiteUnconnectedClientStats",
            "readOnlyHint": True,
...
def remove_tool() -> None:
    mcp.remove_tool("listSiteUnconnectedClientStats")


async def listSiteUnconnectedClientStats(
