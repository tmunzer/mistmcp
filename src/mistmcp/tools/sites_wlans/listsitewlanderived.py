...
def add_tool():
    mcp.add_tool(
        fn=listSiteWlanDerived,
        name="listSiteWlanDerived",
        description="""Get Wlans Derived""",
        tags={"Sites Wlans"},
        annotations={
            "title": "listSiteWlanDerived",
            "readOnlyHint": True,
...
def remove_tool():
    mcp.remove_tool("listSiteWlanDerived")

async def listSiteWlanDerived(
    site_id: Annotated[UUID, Field(description="""ID of the Mist Site""")],
    resolve: Annotated[Optional[bool], Field(description="""Whether to resolve SITE_VARS""")] | None = None,
    wlan_id: Annotated[Optional[str], Field(description="""Filter by WLAN ID""")] | None = None,
) -> dict:
    """Get Wlans Derived"""
