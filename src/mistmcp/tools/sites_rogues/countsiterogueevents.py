...
def remove_tool():
    mcp.remove_tool("countSiteRogueEvents")
...
async def countSiteRogueEvents(
    ...
    channel: Annotated[Optional[str], Field(description="""Channel over which ap_mac heard ssid/bssid pair""")] | None = None,
