...
async def searchSiteRogueEvents(
    ...
    ssid: Annotated[Optional[str], Field(description="""SSID of the network detected as threat""")],
    bssid: Annotated[Optional[str], Field(description="""BSSID of the network detected as threat""")],
    ap_mac: Annotated[Optional[str], Field(description="""MAC of the device that had strongest signal strength for ssid/bssid pair""")],
    channel: Annotated[Optional[int], Field(description="""Channel over which ap_mac heard ssid/bssid pair""")],
    seen_on_lan: Annotated[Optional[bool], Field(description="""Whether the reporting AP see a wireless client (on LAN) connecting to it""")],
    limit: Optional[int],
