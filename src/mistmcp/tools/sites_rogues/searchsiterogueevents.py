...
async def searchSiteRogueEvents(
    ...
    ssid: Annotated[Optional[str | None], Field(description="""SSID of the network detected as threat""")] = None,
    bssid: Annotated[Optional[str | None], Field(description="""BSSID of the network detected as threat""")] = None,
    ap_mac: Annotated[Optional[str | None], Field(description="""MAC of the device that had strongest signal strength for ssid/bssid pair""")] = None,
    channel: Annotated[Optional[int | None], Field(description="""Channel over which ap_mac heard ssid/bssid pair""")] = None,
    seen_on_lan: Annotated[Optional[bool | None], Field(description="""Whether the reporting AP see a wireless client (on LAN) connecting to it""")] = None,
