...
def remove_tool():
    mcp.remove_tool("searchSiteRogueEvents")

async def searchSiteRogueEvents(
    site_id: Annotated[UUID, Field(description="""ID of the Mist Site""")],
    type: Type = Type.NONE,
    ssid: Annotated[Optional[str], Field(description="""SSID of the network detected as threat""")] | None = None,
    bssid: Annotated[Optional[str], Field(description="""BSSID of the network detected as threat""")] | None = None,
    ap_mac: Annotated[Optional[str], Field(description="""MAC of the device that had strongest signal strength for ssid/bssid pair""")] | None = None,
    channel: Annotated[Optional[int], Field(description="""Channel over which ap_mac heard ssid/bssid pair""")] | None = None,
    seen_on_lan: Annotated[Optional[bool], Field(description="""Whether the reporting AP see a wireless client (on LAN) connecting to it""")] | None = None,
