...
def add_tool():
    mcp.add_tool(
        fn=listSiteGatewayTemplateDerived,
        name="listSiteGatewayTemplateDerived",
        description="""Get derived Gateway Templates for Site""",
        tags={"Sites Gateway Templates"},
        annotations={
            "title": "listSiteGatewayTemplateDerived",
            "readOnlyHint": True,
...
def remove_tool():
    mcp.remove_tool("listSiteGatewayTemplateDerived")

async def listSiteGatewayTemplateDerived(
    ...
    response = mistapi.api.v1.sites.gatewaytemplates.listSiteGatewayTemplateDerived(
            apisession,
            site_id=str(site_id),
            resolve=resolve,
    )
