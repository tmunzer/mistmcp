...
def add_tool():
    mcp.add_tool(
        fn=getOrgGatewayTemplate,
        name="getOrgGatewayTemplate",
        description="""Get Organization Gateway Template details""",
        tags={"Orgs Gateway Templates"},
        annotations={
            "title": "getOrgGatewayTemplate",
            "readOnlyHint": True,
...
def remove_tool():
    mcp.remove_tool("getOrgGatewayTemplate")

async def getOrgGatewayTemplate(
    org_id: Annotated[UUID, Field(description="""ID of the Mist Org""")],
    gatewaytemplate_id: Annotated[UUID, Field(description="""ID of the Mist Gatewaytemplate""")],
) -> dict:
    ...
    response = mistapi.api.v1.orgs.gatewaytemplates.getOrgGatewayTemplate(
            apisession,
            org_id=str(org_id),
            gatewaytemplate_id=str(gatewaytemplate_id),
    )
