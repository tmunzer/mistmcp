...
def add_tool():
    mcp.add_tool(
        fn=countOrgAuditLogs,
        name="countOrgAuditLogs",
        description="""Count by Distinct Attributes of Audit Logs""",
        tags={"Orgs Logs"},
        annotations={
            "title": "countOrgAuditLogs",
            "readOnlyHint": True,
...
def remove_tool():
    mcp.remove_tool("countOrgAuditLogs")

async def countOrgAuditLogs(
    org_id: Annotated[UUID, Field(description="""ID of the Mist Org""")],
    distinct: Distinct = Distinct.ADMIN_NAME,
    admin_id: Annotated[Optional[str], Field(description="""ID of the Mist Admin""")] | None = None,
    admin_name: Optional[str] | None = None,
