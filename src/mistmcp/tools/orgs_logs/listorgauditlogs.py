...
def remove_tool():
    mcp.remove_tool("listOrgAuditLogs")

async def listOrgAuditLogs(
    org_id: Annotated[UUID, Field(description="""ID of the Mist Org""")],
    site_id: Annotated[Optional[str], Field(description="""Site id""")] | None = None,
    admin_name: Annotated[Optional[str], Field(description="""Admin name or email""")] | None = None,
    message: Annotated[Optional[str], Field(description="""Message""")] | None = None,
