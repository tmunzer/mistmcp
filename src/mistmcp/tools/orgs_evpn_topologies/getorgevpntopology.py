...
def add_tool():
    mcp.add_tool(
        fn=getOrgEvpnTopology,
        name="getOrgEvpnTopology",
        description="""Get One EVPN Topology Detail""",
        tags={"Orgs EVPN Topologies"},
        annotations={
            "title": "getOrgEvpnTopology",
            "readOnlyHint": True,
...
def remove_tool():
    mcp.remove_tool("getOrgEvpnTopology")

async def getOrgEvpnTopology(
