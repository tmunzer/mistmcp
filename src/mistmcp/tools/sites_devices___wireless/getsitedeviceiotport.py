...
def remove_tool():
    mcp.remove_tool("getSiteDeviceIotPort")

async def getSiteDeviceIotPort(
    ...
    response = mistapi.api.v1.sites.devices.getSiteDeviceIotPort(
            apisession,
            site_id=str(site_id),
