...
def remove_tool() -> None:
    mcp.remove_tool("countOrgPeerPathStats")


async def countOrgPeerPathStats(
    ...
    response = mistapi.api.v1.orgs.stats.countOrgPeerPathStats(
        apisession,
        org_id=str(org_id),
        distinct=distinct,
        start=start,
