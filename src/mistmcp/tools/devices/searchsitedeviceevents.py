...
async def searchSiteDeviceEvents(
    ...
    text: Annotated[Optional[str | None], Field(description="""Event message""")] = None,
    timestamp: Annotated[Optional[str | None], Field(description="""Event time""")] = None,
    ...
    last_by: Annotated[Optional[str | None], Field(description="""Return last/recent event for passed in field""")] = None,
    includes: Annotated[Optional[str | None], Field(description="""Keyword to include events from additional indices (e.g. ext_tunnel for prisma events)""")] = None,
