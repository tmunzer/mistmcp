...
async def searchOrgDevices(
    ...
    band_24_bandwidth: Annotated[Optional[int], Field(description="""If `type`==`ap`, Bandwidth of band_24""")],
    band_24_channel: Annotated[Optional[int], Field(description="""If `type`==`ap`, Channel of band_24""")],
    band_24_power: Annotated[Optional[int], Field(description="""If `type`==`ap`, Power of band_24""")],
    band_5_bandwidth: Annotated[Optional[int], Field(description="""If `type`==`ap`, Bandwidth of band_5""")],
    band_5_channel: Annotated[Optional[int], Field(description="""If `type`==`ap`, Channel of band_5""")],
    band_5_power: Annotated[Optional[int], Field(description="""If `type`==`ap`, Power of band_5""")],
    band_6_bandwidth: Annotated[Optional[int], Field(description="""If `type`==`ap`, Bandwidth of band_6""")],
    band_6_channel: Annotated[Optional[int], Field(description="""If `type`==`ap`, Channel of band_6""")],
    band_6_power: Annotated[Optional[int], Field(description="""If `type`==`ap`, Power of band_6""")],
    cpu: Annotated[Optional[str], Field(description="""If `type`==`switch` or `type`==`gateway`, max cpu usage""")],
    clustered: Annotated[Optional[str], Field(description="""If `type`==`gateway`, true / false""")],
    eth0_port_speed: Annotated[Optional[int], Field(description="""If `type`==`ap`, Port speed of eth0""")],
    evpntopo_id: Annotated[Optional[str], Field(description="""If `type`==`switch`, EVPN topology id""")],
    ...
    ip: Optional[str],
    last_config_status: Annotated[Optional[str], Field(description="""If `type`==`switch` or `type`==`gateway`, last configuration status""")],
    last_hostname: Annotated[Optional[str], Field(description="""If `type`==`switch` or `type`==`gateway`, last hostname""")],
    lldp_mgmt_addr: Annotated[Optional[str], Field(description="""If `type`==`ap`, LLDP management ip address""")],
    lldp_port_id: Annotated[Optional[str], Field(description="""If `type`==`ap`, LLDP port id""")],
    lldp_power_allocated: Annotated[Optional[int], Field(description="""If `type`==`ap`, LLDP Allocated Power""")],
    lldp_power_draw: Annotated[Optional[int], Field(description="""If `type`==`ap`, LLDP Negotiated Power""")],
    lldp_system_desc: Annotated[Optional[str], Field(description="""If `type`==`ap`, LLDP system description""")],
    lldp_system_name: Annotated[Optional[str], Field(description="""If `type`==`ap`, LLDP system name""")],
    mac: Annotated[Optional[str], Field(description="""Device mac""")],
    model: Annotated[Optional[str], Field(description="""Device model""")],
    mxedge_id: Annotated[Optional[str], Field(description="""If `type`==`ap`, Mist Edge id, if AP is connecting to a Mist Edge""")],
    mxedge_ids: Annotated[Optional[str], Field(description="""If `type`==`ap`, Comma separated list of Mist Edge ids, if AP is connecting to a Mist Edge""")],
    mxtunnel_status: Annotated[Optional[Mxtunnel_status], Field(description="""If `type`==`ap`, MxTunnel status, up / down""")] = Mxtunnel_status.NONE,
    node: Annotated[Optional[str], Field(description="""If `type`==`gateway`, `node0` / `node1`""")],
    node0_mac: Annotated[Optional[str], Field(description="""If `type`==`gateway`, mac for node0""")],
    node1_mac: Annotated[Optional[str], Field(description="""If `type`==`gateway`, mac for node1""")],
    power_constrained: Annotated[Optional[bool], Field(description="""If `type`==`ap`, Power_constrained""")],
    site_id: Annotated[Optional[str], Field(description="""Site id""")],
    t128agent_version: Annotated[Optional[str], Field(description="""If `type`==`gateway`,version of 128T agent""")],
    version: Annotated[Optional[str], Field(description="""Version""")],
    type: Annotated[Optional[Type], Field(description="""Type of device. enum: `ap`, `gateway`, `switch`""")] = Type.AP,
    limit: Optional[int],
