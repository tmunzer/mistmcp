...
async def searchOrgDeviceEvents(
    ...
    last_by: Annotated[Optional[str], Field(description="""Return last/recent event for passed in field""")],
    includes: Annotated[Optional[str], Field(description="""Keyword to include events from additional indices (e.g. ext_tunnel for prisma events)""")],
    limit: Optional[int],
