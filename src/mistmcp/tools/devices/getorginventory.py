...
async def getOrgInventory(
    ...
    serial: Annotated[Optional[str | None], Field(description="""Device serial""")] = None,
    ...
    site_id: Annotated[Optional[UUID | None], Field(description="""Site id if assigned, null if not assigned""")] = None,
    vc_mac: Annotated[Optional[str | None], Field(description="""Virtual Chassis MAC Address""")] = None,
    vc: Annotated[Optional[bool | None], Field(description="""To display Virtual Chassis members""")] = None,
    unassigned: Annotated[Optional[bool | None], Field(description="""To display Unassigned devices""")] = None,
    modified_after: Annotated[Optional[int | None], Field(description="""Filter on inventory last modified time, in epoch""")] = None,
