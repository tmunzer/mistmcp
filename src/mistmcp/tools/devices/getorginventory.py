...
async def getOrgInventory(
    ...
    site_id: Annotated[Optional[UUID], Field(description="""Site id if assigned, null if not assigned""")],
    vc_mac: Annotated[Optional[str], Field(description="""Virtual Chassis MAC Address""")],
    vc: Annotated[Optional[bool], Field(description="""To display Virtual Chassis members""")],
    unassigned: Annotated[Optional[bool], Field(description="""To display Unassigned devices""")],
    modified_after: Annotated[Optional[int], Field(description="""Filter on inventory last modified time, in epoch""")],
    limit: Optional[int],
