...
async def searchSiteDevices(
    ...
    power_constrained: Annotated[Optional[bool], Field(description="""power_constrained""")],
    ip: Optional[str],
    mxtunnel_status: Annotated[Optional[Mxtunnel_status], Field(description="""For APs only, MxTunnel status, up / down.""")] = Mxtunnel_status.NONE,
    mxedge_id: Annotated[Optional[UUID], Field(description="""For APs only, Mist Edge id, if AP is connecting to a Mist Edge""")],
    mxedge_ids: Annotated[Optional[list], Field(description="""For APs only, list of Mist Edge id, if AP is connecting to a Mist Edge""")],
    last_hostname: Annotated[Optional[str], Field(description="""For Switches and Gateways only, last hostname""")],
    last_config_status: Annotated[Optional[str], Field(description="""For Switches and Gateways only, last configuration status of the switch/gateway""")],
    radius_stats: Annotated[Optional[str], Field(description="""For Switches and Gateways only, Key-value pairs where the key is the RADIUS server address and the value contains authentication statistics:   *  <server_address> (string): IP address of the RADIUS server as the key   * `auth_accepts` (long): Number of accepted authentication requests   * `auth_rejects` (long): Number of rejected authentication requests   * `auth_timeouts` (long): Number of authentication timeouts   * `auth_server_status` (string): Status of the server. Possible values: `up`, `down`, `unreachable`""")],
    cpu: Annotated[Optional[str], Field(description="""For Switches and Gateways only, max cpu usage""")],
    node0_mac: Annotated[Optional[str], Field(description="""For Gateways only, node0 MAC Address""")],
    clustered: Annotated[Optional[bool], Field(description="""For Gateways only""")],
    t128agent_version: Annotated[Optional[str], Field(description="""For Gateways (SSR) only, version of 128T agent""")],
    node1_mac: Annotated[Optional[str], Field(description="""For Gateways only, node1 MAC Address""")],
    node: Annotated[Optional[Node], Field(description="""For Gateways only. enum: `node0`, `node1`""")] = Node.NONE,
    evpntopo_id: Annotated[Optional[str], Field(description="""For Switches only, EVPN topology id""")],
    lldp_system_name: Annotated[Optional[str], Field(description="""For APs only, LLDP system name""")],
    lldp_system_desc: Annotated[Optional[str], Field(description="""For APs only, LLDP system description""")],
    lldp_port_id: Annotated[Optional[str], Field(description="""For APs only, LLDP port id""")],
    lldp_mgmt_addr: Annotated[Optional[str], Field(description="""For APs only, LLDP management ip address""")],
    band_24_channel: Annotated[Optional[int], Field(description="""Channel of band_24""")],
    ...
    band_24_bandwidth: Annotated[Optional[int], Field(description="""Bandwidth of band_24""")],
    band_5_bandwidth: Annotated[Optional[int], Field(description="""Bandwidth of band_5""")],
    band_6_bandwidth: Annotated[Optional[int], Field(description="""Bandwidth of band_6""")],
    eth0_port_speed: Annotated[Optional[int], Field(description="""Port speed of eth0""")],
    stats: Annotated[Optional[bool], Field(description="""Whether to return device stats""")],
    limit: Optional[int],
    ...
    sort: Annotated[Optional[Sort], Field(description="""Sort options""")] = Sort.TIMESTAMP,
    desc_sort: Annotated[Optional[Desc_sort], Field(description="""Sort options in reverse order""")] = Desc_sort.NONE,
