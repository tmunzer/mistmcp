...
def remove_tool():
    mcp.remove_tool("getOrgOtherDevice")

async def getOrgOtherDevice(
    org_id: Annotated[UUID, Field(description="""ID of the Mist Org""")],
    device_mac: str,
) -> dict:
    """Get Org other device (3rd party device)"""

    response = mistapi.api.v1.orgs.otherdevices.getOrgOtherDevice(
            apisession,
            org_id=str(org_id),
