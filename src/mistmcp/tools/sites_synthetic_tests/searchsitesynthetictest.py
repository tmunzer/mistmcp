...
async def searchSiteSyntheticTest(
    ...
    mac: Annotated[Optional[str], Field(description="""Device MAC Address""")] | None = None,
    port_id: Annotated[Optional[str], Field(description="""Port_id used to run the test (for SSR only)""")] | None = None,
    vlan_id: Annotated[Optional[str], Field(description="""VLAN ID""")] | None = None,
    by: Annotated[Optional[str], Field(description="""Entity who triggers the test""")] | None = None,
    reason: Annotated[Optional[str], Field(description="""Test failure reason""")] | None = None,
    type: Annotated[Type, Field(description="""Synthetic test type""")] = Type.NONE,
    protocol: Annotated[Protocol, Field(description="""Connectivity protocol""")] = Protocol.NONE,
    tenant: Annotated[Optional[str], Field(description="""Tenant network in which lan_connectivity test was run""")] | None = None,
) -> dict:
