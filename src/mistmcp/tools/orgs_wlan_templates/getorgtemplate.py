...
def add_tool():
    mcp.add_tool(
        ...
        tags={"Orgs WLAN Templates"},
        annotations={
            "title": "getOrgTemplate",
            "readOnlyHint": True,
...
def remove_tool():
    mcp.remove_tool("getOrgTemplate")

async def getOrgTemplate(
    org_id: Annotated[UUID, Field(description="""ID of the Mist Org""")],
    template_id: Annotated[UUID, Field(description="""ID of the Mist Template""")],
) -> dict:
