...
async def listOrgAuditLogs(
    ...
    admin_name: Annotated[Optional[str | None], Field(description="""Admin name or email""")] = None,
    message: Annotated[Optional[str | None], Field(description="""Message""")] = None,
    sort: Annotated[Optional[Sort | None], Field(description="""Sort order""")] = Sort.NONE,
