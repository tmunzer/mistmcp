...
async def searchOrgSites(
    ...
    analytic_enabled: Annotated[Optional[bool | None], Field(description="""If Advanced Analytic feature is enabled""")] = None,
    app_waking: Annotated[Optional[bool | None], Field(description="""If App Waking feature is enabled""")] = None,
    asset_enabled: Annotated[Optional[bool | None], Field(description="""If Asset Tracking is enabled""")] = None,
    auto_upgrade_enabled: Annotated[Optional[bool | None], Field(description="""If Auto Upgrade feature is enabled""")] = None,
    auto_upgrade_version: Annotated[Optional[str | None], Field(description="""If Auto Upgrade feature is enabled""")] = None,
    country_code: Annotated[Optional[str | None], Field(description="""Site country code""")] = None,
    honeypot_enabled: Annotated[Optional[bool | None], Field(description="""If Honeypot detection is enabled""")] = None,
    id: Annotated[Optional[str | None], Field(description="""Site id""")] = None,
    locate_unconnected: Annotated[Optional[bool | None], Field(description="""If unconnected client are located""")] = None,
    mesh_enabled: Annotated[Optional[bool | None], Field(description="""If Mesh feature is enabled""")] = None,
    name: Annotated[Optional[str | None], Field(description="""Site name""")] = None,
    rogue_enabled: Annotated[Optional[bool | None], Field(description="""If Rogue detection is enabled""")] = None,
    remote_syslog_enabled: Annotated[Optional[bool | None], Field(description="""If Remote Syslog is enabled""")] = None,
    rtsa_enabled: Annotated[Optional[bool | None], Field(description="""If managed mobility feature is enabled""")] = None,
    vna_enabled: Annotated[Optional[bool | None], Field(description="""If Virtual Network Assistant is enabled""")] = None,
    wifi_enabled: Annotated[Optional[bool | None], Field(description="""If Wi-Fi feature is enabled""")] = None,
