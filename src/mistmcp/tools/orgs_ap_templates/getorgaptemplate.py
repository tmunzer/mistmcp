...
def add_tool() -> None:
    mcp.add_tool(
        ...
        tags={"Orgs AP Templates"},
        annotations={
            "title": "getOrgAptemplate",
            "readOnlyHint": True,
...
def remove_tool() -> None:
    mcp.remove_tool("getOrgAptemplate")


async def getOrgAptemplate(
    org_id: Annotated[UUID, Field(description="""ID of the Mist Org""")],
    aptemplate_id: Annotated[UUID, Field(description="""ID of the Mist Aptemplate""")],
) -> dict:
    """Get AP Template"""
