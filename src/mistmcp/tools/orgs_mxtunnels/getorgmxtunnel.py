...
def remove_tool():
    mcp.remove_tool("getOrgMxTunnel")

async def getOrgMxTunnel(
    org_id: Annotated[UUID, Field(description="""ID of the Mist Org""")],
    mxtunnel_id: Annotated[UUID, Field(description="""ID of the Mist Mxtunnel""")],
) -> dict:
