...
def add_tool():
    mcp.add_tool(
        fn=getOrgMxEdgeCluster,
        name="getOrgMxEdgeCluster",
        description="""Get Org MxEdge Cluster Details""",
        tags={"Orgs MxClusters"},
        annotations={
            "title": "getOrgMxEdgeCluster",
            "readOnlyHint": True,
...
def remove_tool():
    mcp.remove_tool("getOrgMxEdgeCluster")

async def getOrgMxEdgeCluster(
    org_id: Annotated[UUID, Field(description="""ID of the Mist Org""")],
    mxcluster_id: Annotated[UUID, Field(description="""ID of the Mist Mxcluster""")],
) -> dict:
