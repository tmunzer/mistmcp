...
def add_tool():
    mcp.add_tool(
        fn=listSiteRfTemplateDerived,
        name="listSiteRfTemplateDerived",
        description="""Get derived RF Templates for Site""",
        tags={"Sites RF Templates"},
        annotations={
            "title": "listSiteRfTemplateDerived",
            "readOnlyHint": True,
...
def remove_tool():
    mcp.remove_tool("listSiteRfTemplateDerived")

async def listSiteRfTemplateDerived(
