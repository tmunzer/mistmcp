...
async def searchOrgNacClientEvents(
    ...
    vlan: Annotated[Optional[int], Field(description="""Vlan name or ID assigned to the client""")] | None = None,
    ...
    resp_attrs: Annotated[Optional[list], Field(description="""Radius attributes returned by NAC to NAS derive""")] | None = None,
