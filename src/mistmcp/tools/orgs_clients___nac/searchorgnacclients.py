...
def remove_tool():
    mcp.remove_tool("searchOrgNacClients")
...
async def searchOrgNacClients(
    ...
    mdm_provider: Annotated[Optional[str], Field(description="""MDM provider of client’s organization eg 'intune', 'jamf'""")] | None = None,
