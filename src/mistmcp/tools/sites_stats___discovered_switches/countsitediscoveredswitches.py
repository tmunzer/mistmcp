...
def remove_tool():
    mcp.remove_tool("countSiteDiscoveredSwitches")

async def countSiteDiscoveredSwitches(
    site_id: Annotated[UUID, Field(description="""ID of the Mist Site""")],
    distinct: Distinct = Distinct.SYSTEM_NAME,
    ...
    response = mistapi.api.v1.sites.stats.countSiteDiscoveredSwitches(
            apisession,
            site_id=str(site_id),
