...
def remove_tool():
    mcp.remove_tool("searchSiteDiscoveredSwitches")
...
async def searchSiteDiscoveredSwitches(
    ...
    response = mistapi.api.v1.sites.stats.searchSiteDiscoveredSwitches(
            apisession,
            site_id=str(site_id),
            adopted=adopted,
