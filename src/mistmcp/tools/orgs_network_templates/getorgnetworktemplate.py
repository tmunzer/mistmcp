...
def add_tool():
    mcp.add_tool(
        fn=getOrgNetworkTemplate,
        name="getOrgNetworkTemplate",
        description="""Get Org Network Templates Details""",
        tags={"Orgs Network Templates"},
        annotations={
            "title": "getOrgNetworkTemplate",
            "readOnlyHint": True,
...
def remove_tool():
    mcp.remove_tool("getOrgNetworkTemplate")

async def getOrgNetworkTemplate(
    org_id: Annotated[UUID, Field(description="""ID of the Mist Org""")],
    networktemplate_id: Annotated[UUID, Field(description="""ID of the Mist Networktemplate""")],
) -> dict:
    ...
    response = mistapi.api.v1.orgs.networktemplates.getOrgNetworkTemplate(
            apisession,
            org_id=str(org_id),
            networktemplate_id=str(networktemplate_id),
    )
