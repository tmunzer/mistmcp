...
async def searchOrgWirelessClients(
    ...
    band: Annotated[Optional[str], Field(description="""Radio band. enum: `24`, `5`, `6`""")] | None = None,
    device: Annotated[Optional[str], Field(description="""Device type, e.g. Mac, Nvidia, iPhone""")] | None = None,
    os: Annotated[Optional[str], Field(description="""Only available for clients running the Marvis Client app, os, e.g. Sierra, Yosemite, Windows 10""")] | None = None,
    model: Annotated[Optional[str], Field(description="""Only available for clients running the Marvis Client app, model, e.g. 'MBP 15 late 2013', 6, 6s, '8+ GSM'""")] | None = None,
    ...
    psk_name: Annotated[Optional[str], Field(description="""Only available for clients using PPSK authentication, the Name of the PSK""")] | None = None,
    username: Annotated[Optional[str], Field(description="""Only available for clients using 802.1X authentication, partial / full username""")] | None = None,
    vlan: Annotated[Optional[str], Field(description="""VLAN""")] | None = None,
    ssid: Annotated[Optional[str], Field(description="""SSID""")] | None = None,
    text: Annotated[Optional[str], Field(description="""Partial / full MAC address, hostname, username, psk_name or ip""")] | None = None,
