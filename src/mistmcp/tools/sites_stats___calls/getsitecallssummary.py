...
def remove_tool():
    mcp.remove_tool("getSiteCallsSummary")

async def getSiteCallsSummary(
    site_id: Annotated[UUID, Field(description="""ID of the Mist Site""")],
    ap_mac: Annotated[Optional[str], Field(description="""AP MAC, optional""")] | None = None,
    app: Annotated[Optional[str], Field(description="""APp name (`zoom` or `teams`). default is both. Optional""")] | None = None,
