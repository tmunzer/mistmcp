...
def add_tool():
    mcp.add_tool(
        fn=getSiteMxEdgeStats,
        name="getSiteMxEdgeStats",
        description="""Get One Site MxEdge Stats""",
        tags={"Sites Stats - MxEdges"},
        annotations={
            "title": "getSiteMxEdgeStats",
            "readOnlyHint": True,
...
def remove_tool():
    mcp.remove_tool("getSiteMxEdgeStats")

async def getSiteMxEdgeStats(
