...
async def searchSiteWanUsage(
    ...
    peer_mac: Annotated[Optional[str | None], Field(description="""Peer MAC address""")] = None,
    port_id: Annotated[Optional[str | None], Field(description="""Port ID for the device""")] = None,
    peer_port_id: Annotated[Optional[str | None], Field(description="""Peer Port ID for the device""")] = None,
    policy: Annotated[Optional[str | None], Field(description="""Policy for the wan path""")] = None,
    tenant: Annotated[Optional[str | None], Field(description="""Tenant network in which the packet is sent""")] = None,
    path_type: Annotated[Optional[str | None], Field(description="""path_type of the port""")] = None,
