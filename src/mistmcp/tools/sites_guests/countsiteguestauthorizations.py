...
def remove_tool():
    mcp.remove_tool("countSiteGuestAuthorizations")

async def countSiteGuestAuthorizations(
    ...
    response = mistapi.api.v1.sites.guests.countSiteGuestAuthorizations(
            apisession,
            site_id=str(site_id),
