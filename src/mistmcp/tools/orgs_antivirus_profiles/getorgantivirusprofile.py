...
def add_tool():
    mcp.add_tool(
        fn=getOrgAntivirusProfile,
        name="getOrgAntivirusProfile",
        description="""Get Org Antivirus Profile""",
        tags={"Orgs Antivirus Profiles"},
        annotations={
            "title": "getOrgAntivirusProfile",
            "readOnlyHint": True,
...
def remove_tool():
    mcp.remove_tool("getOrgAntivirusProfile")

async def getOrgAntivirusProfile(
    org_id: Annotated[UUID, Field(description="""ID of the Mist Org""")],
    avprofile_id: Annotated[UUID, Field(description="""ID of the Mist Avprofile""")],
) -> dict:
