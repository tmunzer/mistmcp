...
def add_tool():
    mcp.add_tool(
        fn=listSiteApTemplateDerived,
        name="listSiteApTemplateDerived",
        description="""Get derived AP Templates for Site""",
        tags={"Sites AP Templates"},
        annotations={
            "title": "listSiteApTemplateDerived",
            "readOnlyHint": True,
...
def remove_tool():
    mcp.remove_tool("listSiteApTemplateDerived")

async def listSiteApTemplateDerived(
    ...
    response = mistapi.api.v1.sites.aptemplates.listSiteApTemplateDerived(
            apisession,
            site_id=str(site_id),
            resolve=resolve,
    )
