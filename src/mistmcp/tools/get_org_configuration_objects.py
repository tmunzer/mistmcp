...
@mcp.tool(
    name="mist_get_org_configuration_objects",
    description="""Retrieve configuration objects from a specified organization""",
    tags={"configuration"},
    annotations={
        "title": "Get org configuration objects",
        "readOnlyHint": True,
...
async def get_org_configuration_objects(
    ...
    logger.debug("Tool get_org_configuration_objects called")
