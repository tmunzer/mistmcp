...
def remove_tool() -> None:
    mcp.remove_tool("listGatewayApplications")


async def listGatewayApplications() -> dict:
    """Get the full list of applications that we recognize"""

    response = mistapi.api.v1.const.gateway_applications.listGatewayApplications(
        apisession,
    )
