...
def add_tool():
    mcp.add_tool(
        ...
        annotations={
            "title": "listAppCategoryDefinitions",
            "readOnlyHint": True,
...
def remove_tool():
    mcp.remove_tool("listAppCategoryDefinitions")

async def listAppCategoryDefinitions() -> dict:
    ...
    response = mistapi.api.v1.const.app_categories.listAppCategoryDefinitions(
            apisession,
    )
