...
def add_tool():
    mcp.add_tool(
        fn=listAppSubCategoryDefinitions,
        ...
        annotations={
            "title": "listAppSubCategoryDefinitions",
            "readOnlyHint": True,
...
def remove_tool():
    mcp.remove_tool("listAppSubCategoryDefinitions")

async def listAppSubCategoryDefinitions() -> dict:
    ...
    response = mistapi.api.v1.const.app_subcategories.listAppSubCategoryDefinitions(
            apisession,
    )
