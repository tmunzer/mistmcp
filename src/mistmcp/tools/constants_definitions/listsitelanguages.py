...
def remove_tool():
    mcp.remove_tool("listSiteLanguages")

async def listSiteLanguages() -> dict:
    """Get List of Languages"""

    response = mistapi.api.v1.const.languages.listSiteLanguages(
            apisession,
    )
