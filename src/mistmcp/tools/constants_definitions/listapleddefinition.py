...
def remove_tool():
    mcp.remove_tool("listApLedDefinition")

async def listApLedDefinition() -> dict:
    """Get List of AP LED definition"""

    response = mistapi.api.v1.const.ap_led_status.listApLedDefinition(
            apisession,
    )
