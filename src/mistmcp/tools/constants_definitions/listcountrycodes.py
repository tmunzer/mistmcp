...
def remove_tool():
    mcp.remove_tool("listCountryCodes")

async def listCountryCodes(
    extend: Annotated[Optional[bool], Field(description="""Will include more country codes if true""")] | None = None,
) -> dict:
    """Get List of available Country Codes"""

    response = mistapi.api.v1.const.countries.listCountryCodes(
            apisession,
            extend=extend,
    )
