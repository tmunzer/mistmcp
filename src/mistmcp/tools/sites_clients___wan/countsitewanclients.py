...
def remove_tool():
    mcp.remove_tool("countSiteWanClients")

async def countSiteWanClients(
    ...
    response = mistapi.api.v1.sites.wan_clients.countSiteWanClients(
            apisession,
            site_id=str(site_id),
