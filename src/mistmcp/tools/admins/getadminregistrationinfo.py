...
def remove_tool():
    mcp.remove_tool("getAdminRegistrationInfo")

async def getAdminRegistrationInfo(
    recaptcha_flavor: Recaptcha_flavor = Recaptcha_flavor.GOOGLE,
) -> dict:
    """Get Registration Information"""

    response = mistapi.api.v1.register.recaptcha.getAdminRegistrationInfo(
            apisession,
            recaptcha_flavor=recaptcha_flavor.value,
    )
