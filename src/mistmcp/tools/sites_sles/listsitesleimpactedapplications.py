...
def add_tool():
    mcp.add_tool(
        fn=listSiteSleImpactedApplications,
        name="listSiteSleImpactedApplications",
        description="""For WAN SLEs. List the impacted interfaces optionally filtered by classifier and failure type""",
        tags={"Sites SLEs"},
        annotations={
            "title": "listSiteSleImpactedApplications",
            "readOnlyHint": True,
...
def remove_tool():
    mcp.remove_tool("listSiteSleImpactedApplications")

async def listSiteSleImpactedApplications(
