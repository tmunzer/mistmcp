...
def add_tool() -> None:
    mcp.add_tool(
        fn=listSiteSleImpactedWirelessClients,
        ...
        tags={"Sites SLEs"},
        annotations={
            "title": "listSiteSleImpactedWirelessClients",
            "readOnlyHint": True,
...
def remove_tool() -> None:
    mcp.remove_tool("listSiteSleImpactedWirelessClients")


async def listSiteSleImpactedWirelessClients(
