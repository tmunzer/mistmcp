...
def add_tool():
    mcp.add_tool(
        fn=ListSiteWxRulesDerived,
        name="ListSiteWxRulesDerived",
        description="""Get Site WxLan Rule Derived""",
        tags={"Sites WxRules"},
        annotations={
            "title": "ListSiteWxRulesDerived",
            "readOnlyHint": True,
...
def remove_tool():
    mcp.remove_tool("ListSiteWxRulesDerived")

async def ListSiteWxRulesDerived(
