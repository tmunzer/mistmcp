...
class McpToolsCategory(Enum):
    ...
    MARVIS = "marvis"
    ORGS_NAC = "orgs_nac"
    SITES_NAC_FINGERPRINTS = "sites_nac_fingerprints"
...
TOOLS = {
    ...
    "orgs_nac": {
        ...
        "tools": ["mist_search_org_user_macs"],
    },
    "self_account": {
    ...
    "sites_nac_fingerprints": {
        ...
        "tools": ["mist_search_site_client_fingerprints"],
    },
    "sites_rogues": {
