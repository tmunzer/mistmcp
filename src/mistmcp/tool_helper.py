...
class McpToolsCategory(Enum):
    ...
    ORGS = "orgs"
    TEMPLATES_WAN = "templates_wan"
    TEMPLATES_ALARMS = "templates_alarms"
    TEMPLATES_DEVICES = "templates_devices"
...
TOOLS = {
    ...
    "marvis": {
        ...
        "tools": ["troubleshootOrg", "searchSiteSyntheticTest"],
    },
    "mxedges": {
    ...
    "templates_alarms": {
        "description": "Alarm templates at the sites and organizations level. It provides access to alarm templates, which can be used to configure alarms in a consistent manner.",
        "tools": [
    ...
    "templates_devices": {
        "description": "Device profiles at the sites and organizations level. It provides access to device templates and profiles, which can be used to configure devices in a consistent manner.",
        "tools": [
            "listOrgAptemplates",
    ...
    "templates_switches": {
        "description": "Switches Configuration related objects for the sites and organizations. It provides access to EVPN topologies and network templates, which can be used to configure switches in a consistent manner. Networks templates are assigned to sites.",
        "tools": [
    ...
    "templates_wan": {
        "description": "WAN Configuration related objects for the sites and organizations. It provides access to applications, gateway templates, security intelligence profiles, service policies, services, networks, and VPNs. These templates can be used to configure WAN in a consistent manner and are assigned to sites.",
        "tools": [
            "listOrgAAMWProfiles",
