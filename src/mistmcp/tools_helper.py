...
TOOLS = {
    ...
    "sites_devices___wired": {
        "tools": [],
        "description": "tools specific to the Juniper Switches managed by Mist",
    },
